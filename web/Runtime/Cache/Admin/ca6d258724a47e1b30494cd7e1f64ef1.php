...
<body>
<form method="post" action="/amazon_spider/web/index.php/Admin/User/get_user" id="listform">
  <div class="panel admin-panel">
    <div class="padding border-bottom">
    </div>
    <table class="table table-hover text-center">
      <tr>
        <th width="12%" style="">title</th>
        <th width="12%">price</th>
        <th width="12%" style="">color</th>
        <th width="12%">size</th>
	<th width="12%">commentCount</th>
	<th width="12%">commentRating</th>
	<th width="12%">follow_sale_num</th>
      </tr>
      <?php if(empty($data)): ?>
      		<tr>
      			<td></td>
