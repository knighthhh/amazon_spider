...
<div class="header bg-main">
  <div class="logo margin-big-left fadein-top">
    ...
    <h1><img src="<?php echo (ADMIN_IMAGES_URL); ?>y.png" class="radius-circle rotate-hover" height="50" alt="" />亚马逊爬虫管理中心</h1>
  ...
  <div class="head-l"><a class="button button-little bg-red" href="/amazon_spider/web/index.php/Admin/Login/logout"><span class="icon-power-off"></span> 退出登录</a> </div>
</div>
<div class="leftnav" style="overflow-x:scroll">
  ...
  <h2><span class="fa fa-user-circle"></span>数据管理</h2>
  <ul> 
   	<?php  echo authCheck(MODULE_NAME.'/User/get_user',cookie('id'),'<li><a href="/amazon_spider/web/index.php/Admin/User/get_user" target="right"><span class="icon-caret-right"></span>详情</a></li>'); ?>
  </ul>   
  <ul> 
   	<?php  echo authCheck(MODULE_NAME.'/Car/get_item',cookie('id'),'<li><a href="/amazon_spider/web/index.php/Admin/Car/get_item" target="right"><span class="icon-caret-right"></span>配件信息</a></li>'); ?>
  </ul>   
